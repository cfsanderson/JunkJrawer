...
let customer = {name : "Bob Thomas", address : "123 Main", balance : 50.50};
...
// ---------- ARRAYS ----------
// Arrays have letiable sizes and can contain multiple types in JS
let tomSmith = ["Tom Smith", "123 Main", 120.50];
...
for (let i = 0; i < tomSmith.length; i++) {
...
// Local letiables defined in functions can't be accessed outside of
// the function
...
let myBD = new Date("December 21, 2015");

let msForBD = myBD.getTime();
let timeNow = curDate.getTime();
let tilMyBD = msForBD - timeNow;
...
onChange="let dataEntered=document.getElementById('randInput').value; alert('User Typed ' + dataEntered);"><br /><br />
